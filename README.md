...
[![packageversion](https://img.shields.io/badge/Package%20version-4.0-21-orange.svg?style=flat-square)](commits/master)
[![Last-changedate](https://img.shields.io/badge/last%20change-2018--01--25-yellowgreen.svg)](/commits/master)
...
The `asremlPlus` package is distributed under the [BSD-3-Clause licence](<https://opensource.org/licenses/BSD-3-Clause>) -- for details see [LICENSE.md](commits/master).
